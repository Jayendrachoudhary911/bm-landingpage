...
const M3_EXPRESSIVE_PALETTE = {
  blue: {
    ...
    dark: { bg: "#8bbaef", text: "#203362", container: "#aed4ff", onContainer: "#457ed8", badgeBg: "#003F7D" },
  },
  amber: {
    accent: "#f5d397",
    ...
    dark: { bg: "#e8d499", text: "#271900", container: "#fff3df", onContainer: "#d99f17", badgeBg: "#594300" },
  },
  emerald: {
    accent: "#8cefcb",
    ...
    dark: { bg: "#9ff8c7", text: "#21542e", container: "#d8ffe9", onContainer: "#17c14d", badgeBg: "#005228" },
  },
  orange: {
    accent: "#ffd6b4",
    ...
    dark: { bg: "#ffc7a7", text: "#703e26", container: "#ffe0d3", onContainer: "#fb712c", badgeBg: "#772F03" },
  },
  purple: {
    accent: "#c8b6ff",
    ...
    dark: { bg: "#d4bbff", text: "#44236f", container: "#e7d5ff", onContainer: "#a473ff", badgeBg: "#422271" },
  },
};
