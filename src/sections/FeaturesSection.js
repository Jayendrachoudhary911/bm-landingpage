...
const FeaturesSection = () => {
  ...
  const activeFeature = features[activeCardIndex] || features[0] || FALLBACK_BUNKMATE_FEATURES[0];
        ...
        >
          ...
          <Box sx={{ position: "relative", pb: { xs: 8, md: 14 }, zIndex: { xs: 40, lg: 10 } }}>
            {features.map((feature, index) => {
              const tiltDegree = (index % 2 === 0 ? -1 : 1) * (3.5 - (index % 2) * 1);
              ...
              return (
                <Box
                  ...
                  sx={{
                    position: "sticky",
                    top: { xs: 480, sm: 295, lg: 220 },
                    zIndex: index + 1,
                    mb: index === features.length - 1 ? 0 : { xs: 14, sm: 20, md: 24 },
                    display: "flex",
                ...
                >
                  <Paper
                    ...
                    sx={{
                      ...
                      color: m3Theme.text,
                      boxShadow:
                        "inset 0 1px 1px rgba(0, 0, 0, 0.2), inset 0 -1px 1px rgba(0, 0, 0, 0.07), 0 1px 0px rgba(0, 0, 0, 0.18)",
                      display: "flex",
                      flexDirection: "column",
                      gap: { xs: 1.8, sm: 2.5 },
        ...
        >
          ...
          >
            <Box sx={{ maxWidth: 460 }}>
              ...
              >
                Still packing more into{" "}
                <Typography
                  component="span"
                  sx={{ fontSize: { xs: "1.5rem", sm: "1.85rem", md: "2.1rem" }, fontWeight: 850, color: colors.secondaryText }}
                >
                  BunkMates.
                </Typography>
              </Typography>
